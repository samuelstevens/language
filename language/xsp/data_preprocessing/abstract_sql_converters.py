  ...
  """
    ...
    for sql_span in sql_spans:
        if sql_span.sql_token:
            ...
            successful_copy = (
                _add_value_literal(sql_span.value_literal, example, anonymize)
                and successful_copy
            )
        elif sql_span.column:
            _add_column_copy(
                sql_span.column.table_name, sql_span.column.column_name, example
            )
        elif sql_span.table_name:
            _add_table_copy(sql_span.table_name, example)
        elif sql_span.nested_statement:
            successful_copy = (
                populate_example_from_sql_spans(
                    sql_span.nested_statement, example, anonymize
                )
                and successful_copy
            )
        else:
        ...
        for end_idx in range(action_idx + 1, len(sql_query.actions)):
            ...
            if nested_action.symbol == ")":
                if open_parens > 0:
                    ...
                    return end_idx
        raise ParseError(
            "Could not find end index for nested statement: %s" % sql_query
        )
    return None
...
def spider_db_to_table_tuples(db):
    ...
    table_schemas = []
    for table_name, column_names in zip(table_names, column_names_indexed_by_table):
        table_schemas.append(
            abstract_sql.TableSchema(
                table_name=table_name.lower(), column_names=column_names,
            )
...
def michigan_db_to_foreign_key_tuples_orcale(dataset_name):
    ...
    if dataset_name == "academic":
        return [
            ...
            abstract_sql.ForeignKeyRelation("conference", "publication", "cid", "cid"),
            abstract_sql.ForeignKeyRelation(
                "publication", "publication_keyword", "pid", "pid"
            ),
            abstract_sql.ForeignKeyRelation(
                "keyword", "publication_keyword", "kid", "kid"
            ),
            abstract_sql.ForeignKeyRelation("author", "organization", "oid", "oid"),
            abstract_sql.ForeignKeyRelation("author", "domain_author", "aid", "aid"),
            abstract_sql.ForeignKeyRelation("domain", "domain_author", "did", "did"),
            abstract_sql.ForeignKeyRelation(
                "domain", "domain_publication", "did", "did"
            ),
            abstract_sql.ForeignKeyRelation(
                "domain_publication", "publication", "pid", "pid"
            ),
            abstract_sql.ForeignKeyRelation("cite", "publication", "cited", "pid"),
            abstract_sql.ForeignKeyRelation("cite", "publication", "citing", "pid"),
            abstract_sql.ForeignKeyRelation("domain", "domain_keyword", "did", "did"),
            abstract_sql.ForeignKeyRelation("domain_keyword", "keyword", "kid", "kid"),
            abstract_sql.ForeignKeyRelation("domain", "domain_journal", "did", "did"),
            abstract_sql.ForeignKeyRelation("domain_journal", "journal", "jid", "jid"),
            abstract_sql.ForeignKeyRelation(
                "conference", "domain_conference", "cid", "cid"
            ),
            abstract_sql.ForeignKeyRelation(
                "domain", "domain_conference", "did", "did"
            ),
        ]
    elif dataset_name == "advising":
        return [
            abstract_sql.ForeignKeyRelation(
                "course", "course_offering", "course_id", "course_id"
            ),
            abstract_sql.ForeignKeyRelation(
                "course_offering", "semester", "semester", "semester_id"
            ),
            abstract_sql.ForeignKeyRelation(
                "course", "program_course", "course_id", "course_id"
            ),
            abstract_sql.ForeignKeyRelation(
                "course_offering", "offering_instructor", "offering_id", "offering_id"
            ),
            abstract_sql.ForeignKeyRelation(
                "instructor", "offering_instructor", "instructor_id", "instructor_id"
            ),
            abstract_sql.ForeignKeyRelation(
                "course", "course_prerequisite", "course_id", "course_id"
            ),
            abstract_sql.ForeignKeyRelation(
                "course", "course_prerequisite", "course_id", "pre_course_id"
            ),
            abstract_sql.ForeignKeyRelation(
                "course_offering", "program_course", "course_id", "course_id"
            ),
            abstract_sql.ForeignKeyRelation("area", "course", "course_id", "course_id"),
            abstract_sql.ForeignKeyRelation(
                "program", "program_course", "program_id", "program_id"
            ),
            abstract_sql.ForeignKeyRelation(
                "course", "student_record", "course_id", "course_id"
            ),
            abstract_sql.ForeignKeyRelation(
                "offering_instructor", "student_record", "offering_id", "offering_id"
            ),
            abstract_sql.ForeignKeyRelation(
                "area", "student_record", "course_id", "course_id"
            ),
            abstract_sql.ForeignKeyRelation(
                "gsi", "student", "student_id", "student_id"
            ),
            abstract_sql.ForeignKeyRelation(
                "course_offering", "gsi", "offering_id", "course_offering_id"
            ),
            abstract_sql.ForeignKeyRelation(
                "program_course", "student_record", "course_id", "course_id"
            ),
            abstract_sql.ForeignKeyRelation(
                "student", "student_record", "student_id", "student_id"
            ),
            abstract_sql.ForeignKeyRelation(
                "offering_instructor",
                "offering_instructor",
            ...
            abstract_sql.ForeignKeyRelation(
                "program", "program_requirement", "program_id", "program_id"
            ),
            abstract_sql.ForeignKeyRelation(
                "course_offering", "course_offering", "semester", "semester"
            ),
            abstract_sql.ForeignKeyRelation(
                "semester", "student_record", "semester_id", "semester"
            ),
            abstract_sql.ForeignKeyRelation(
                "area", "course_offering", "course_id", "course_id"
            ),
            abstract_sql.ForeignKeyRelation(
        ...
        return [
            abstract_sql.ForeignKeyRelation(
                "airport_service", "city", "city_code", "city_code"
            ),
            abstract_sql.ForeignKeyRelation(
                "airport_service", "flight", "airport_code", "from_airport"
            ),
            abstract_sql.ForeignKeyRelation(
                "airport_service", "flight", "airport_code", "to_airport"
            ),
            abstract_sql.ForeignKeyRelation("date_day", "days", "day_name", "day_name"),
            abstract_sql.ForeignKeyRelation(
                "days", "flight", "days_code", "flight_days"
            ),
            abstract_sql.ForeignKeyRelation(
                "fare", "flight_fare", "fare_id", "fare_id"
            ),
            abstract_sql.ForeignKeyRelation(
                "flight", "flight_fare", "flight_id", "flight_id"
            ),
            abstract_sql.ForeignKeyRelation(
                "fare", "fare_basis", "fare_basis_code", "fare_basis_code"
            ),
            abstract_sql.ForeignKeyRelation(
                "flight", "flight_stop", "flight_id", "flight_id"
            ),
            abstract_sql.ForeignKeyRelation(
                "days", "fare_basis", "days_code", "basis_days"
            ),
            abstract_sql.ForeignKeyRelation(
                "airport_service", "flight_stop", "airport_code", "stop_airport"
            ),
            abstract_sql.ForeignKeyRelation(
                "city", "ground_service", "city_code", "city_code"
            ),
            abstract_sql.ForeignKeyRelation(
                "airline", "flight", "airline_code", "airline_code"
            ),
            abstract_sql.ForeignKeyRelation(
                "airport", "airport_service", "airport_code", "airport_code"
            ),
            abstract_sql.ForeignKeyRelation(
                "flight", "food_service", "meal_code", "meal_code"
            ),
            abstract_sql.ForeignKeyRelation(
                "aircraft", "equipment_sequence", "aircraft_code", "aircraft_code"
            ),
            abstract_sql.ForeignKeyRelation(
                "equipment_sequence",
                "flight",
            ...
            abstract_sql.ForeignKeyRelation(
                "city", "state", "state_code", "state_code"
            ),
            abstract_sql.ForeignKeyRelation(
                "airport", "flight", "airport_code", "to_airport"
            ),
            abstract_sql.ForeignKeyRelation(
                "airport", "ground_service", "airport_code", "airport_code"
            ),
            abstract_sql.ForeignKeyRelation(
                "airport", "flight", "airport_code", "from_airport"
            ),
            abstract_sql.ForeignKeyRelation(
                "airport_service", "fare", "airport_code", "to_airport"
            ),
            abstract_sql.ForeignKeyRelation(
                "airport_service", "fare", "airport_code", "from_airport"
            ),
            abstract_sql.ForeignKeyRelation(
                "flight", "flight_leg", "flight_id", "flight_id"
            ),
            abstract_sql.ForeignKeyRelation(
                "flight", "flight_leg", "flight_id", "leg_flight"
            ),
            abstract_sql.ForeignKeyRelation(
                "class_of_service", "fare_basis", "booking_class", "booking_class"
            ),
            abstract_sql.ForeignKeyRelation(
                "airport", "state", "state_code", "state_code"
            ),
            abstract_sql.ForeignKeyRelation(
                "airport", "flight_stop", "airport_code", "stop_airport"
            ),
            abstract_sql.ForeignKeyRelation(
                "fare", "restriction", "restriction_code", "restriction_code"
            ),
        ]
        ...
        return [
            ...
            abstract_sql.ForeignKeyRelation("directed_by", "director", "did", "did"),
            ...
            abstract_sql.ForeignKeyRelation("classification", "movie", "msid", "mid"),
            abstract_sql.ForeignKeyRelation("made_by", "producer", "pid", "pid"),
            abstract_sql.ForeignKeyRelation("classification", "genre", "gid", "gid"),
            ...
            abstract_sql.ForeignKeyRelation("copyright", "tv_series", "msid", "sid"),
            abstract_sql.ForeignKeyRelation("cast", "tv_series", "msid", "sid"),
            abstract_sql.ForeignKeyRelation("directed_by", "tv_series", "msid", "sid"),
            abstract_sql.ForeignKeyRelation("made_by", "tv_series", "msid", "sid"),
        ]
    elif dataset_name == "geoquery":
        return [
            abstract_sql.ForeignKeyRelation(
                "border_info", "state", "border", "state_name"
            ),
            abstract_sql.ForeignKeyRelation("river", "state", "traverse", "state_name"),
            abstract_sql.ForeignKeyRelation("city", "state", "city_name", "capital"),
            abstract_sql.ForeignKeyRelation(
                "border_info", "state", "state_name", "state_name"
            ),
            abstract_sql.ForeignKeyRelation(
                "city", "state", "state_name", "state_name"
            ),
            abstract_sql.ForeignKeyRelation(
                "border_info", "river", "border", "traverse"
            ),
            abstract_sql.ForeignKeyRelation(
                "highlow", "state", "state_name", "state_name"
            ),
            abstract_sql.ForeignKeyRelation(
                "border_info", "border_info", "border", "state_name"
            ),
            abstract_sql.ForeignKeyRelation(
                "highlow", "river", "state_name", "traverse"
            ),
            abstract_sql.ForeignKeyRelation(
                "border_info", "river", "state_name", "traverse"
            ),
            abstract_sql.ForeignKeyRelation("city", "river", "state_name", "traverse"),
            abstract_sql.ForeignKeyRelation(
                "border_info", "highlow", "border", "state_name"
            ),
            abstract_sql.ForeignKeyRelation(
                "border_info", "city", "border", "state_name"
            ),
        ]
        ...
        return [
            abstract_sql.ForeignKeyRelation("author", "writes", "authorid", "authorid"),
            abstract_sql.ForeignKeyRelation("paper", "writes", "paperid", "paperid"),
            abstract_sql.ForeignKeyRelation(
                "keyphrase", "paperkeyphrase", "keyphraseid", "keyphraseid"
            ),
            abstract_sql.ForeignKeyRelation(
                "paper", "paperkeyphrase", "paperid", "paperid"
            ),
            abstract_sql.ForeignKeyRelation("paper", "venue", "venueid", "venueid"),
            abstract_sql.ForeignKeyRelation("cite", "paper", "citedpaperid", "paperid"),
            abstract_sql.ForeignKeyRelation(
            ...
            abstract_sql.ForeignKeyRelation(
                "paperkeyphrase", "writes", "paperid", "paperid"
            ),
            abstract_sql.ForeignKeyRelation(
                "cite", "writes", "citedpaperid", "paperid"
            ),
            abstract_sql.ForeignKeyRelation(
                "cite", "writes", "citingpaperid", "paperid"
            ),
            abstract_sql.ForeignKeyRelation(
                "cite", "paper", "citingpaperid", "paperid"
            ),
            abstract_sql.ForeignKeyRelation(
                "journal", "paper", "journalid", "journalid"
            ),
            abstract_sql.ForeignKeyRelation(
                "field", "paperfield", "fieldid", "fieldid"
            ),
            abstract_sql.ForeignKeyRelation(
                "cite", "paperkeyphrase", "citingpaperid", "paperid"
            ),
            abstract_sql.ForeignKeyRelation(
                "cite", "paperkeyphrase", "citedpaperid", "paperid"
            ),
            abstract_sql.ForeignKeyRelation(
                "paper", "paperfield", "paperid", "paperid"
            ),
        ]
    elif dataset_name == "yelp":
        return [
            abstract_sql.ForeignKeyRelation(
                "business", "category", "business_id", "business_id"
            ),
            ...
            abstract_sql.ForeignKeyRelation(
                "business", "neighborhood", "business_id", "business_id"
            ),
            abstract_sql.ForeignKeyRelation("tip", "user", "user_id", "user_id"),
            abstract_sql.ForeignKeyRelation(
                "business", "tip", "business_id", "business_id"
            ),
            abstract_sql.ForeignKeyRelation(
                "business", "checkin", "business_id", "business_id"
            ),
        ]
    else:
    ...
    for table_name, columns in db.items():
        for data in columns:
            could_have_link = schema_utils.column_is_foreign_key(
                data
            ) or schema_utils.column_is_primary_key(data)
                        ...
                        for other_data in other_columns:
                            ...
                            if other_column == column_name:
                                if schema_utils.column_is_foreign_key(
                                    other_data
                                ) or schema_utils.column_is_primary_key(other_data):
                                    foreign_keys.append(
                                        abstract_sql.ForeignKeyRelation(
