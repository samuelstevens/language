...
class DataOptions(
    collections.namedtuple(
        "DataOptions", ["bert_vocab_path", "max_num_tokens", "max_decode_length"]
    )
):
    pass
...
class ModelParameters(
    collections.namedtuple(
        ...
        [
            ...
            "pretrained_bert_dir",
            "source_embedding_dims",
            "target_embedding_dims",
            "encoder_dims",
            "decoder_dims",
            "max_decoder_relative_distance",
            "num_decoder_layers",
            "num_heads",
            "decoder_ff_layer_hidden_size",
        ],
    )
):
    pass
...
class ModelConfig(
    collections.namedtuple(
        "ModelConfig", ["data_options", "model_parameters", "training_options"]
    )
):
    def __str__(self):
        return json.dumps(
